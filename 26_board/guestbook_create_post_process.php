...
// $sql = "INSERT INTO guestbook_posts (title, content, author_id) VALUES ('$title', '$content', '$author_id')";
...
$stmt = mysqli_prepare(
    $connection,
    "INSERT INTO guestbook_posts (title, content, author_id)
     VALUES (?, ?, ?)"
);
...
//         $upload_dir = 'guestbook_uploads/'; // 파일이 저장될 디렉토리 경로를 지정한다.
