...
// $check_sql = "SELECT * FROM guestbook_comments WHERE id='$comment_id'";
// $check_result = mysqli_query($connection, $check_sql);
// $comment = mysqli_fetch_assoc($check_result);
$stmt = mysqli_prepare(
    $connection,
    "SELECT * FROM guestbook_comments WHERE id=?"
);
...
// $delete_sql = "DELETE FROM guestbook_comments WHERE id='$comment_id'";
// $final_result = mysqli_query($connection, $delete_sql);
$stmt = mysqli_prepare(
    $connection,
    "DELETE FROM guestbook_comments WHERE id=?"
);
