...
<html>
    ...
    <body>
        ...
        <br>
        <a href="guestbook_index.php?writer=<?php echo urlencode($writer); ?>&sort=new">
            최신순
        </a>
        <a href="guestbook_index.php?writer=<?php echo urlencode($writer); ?>&sort=old">
            오래된순
        </a>
        ...
        <?php
            ...
            ?>
                    <a href="guestbook_index.php?writer=<?php echo urlencode($user_row['username']); ?>">
